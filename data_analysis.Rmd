...
use_proportion_figure<- use_proportion_data %>% 
  ...
  theme(axis.line = element_line(colour = "black"),
        axis.text.y = element_text(size = 10)) +  guides(fill=guide_legend(reverse = TRUE))
...
```{r}
raw_data %>% 
mutate(use_proportion_formal_AIMG  = case_when(use_proportion_formal_AIMG ==0 ~0,
                                              use_proportion_formal_AIMG == 1 ~1.5,
                                              use_proportion_formal_AIMG == 2 ~3,
                                              use_proportion_formal_AIMG == 3 ~4.5,
                                              use_proportion_formal_AIMG == 4 ~6)) %>% 
  mutate(use_proportion_class_AIMG  = case_when(use_proportion_class_AIMG == 0 ~0,
                                              use_proportion_class_AIMG == 1 ~1.5,
                                              use_proportion_class_AIMG == 2 ~3,
                                              use_proportion_class_AIMG == 3 ~4.5,
                                              use_proportion_class_AIMG == 4 ~6)) %>% 
  mutate(use_proportion_study_AIMG  = case_when(use_proportion_study_AIMG == 0 ~0,
                                              use_proportion_study_AIMG == 1 ~1.5,
                                              use_proportion_study_AIMG == 2 ~3,
                                              use_proportion_study_AIMG == 3 ~4.5,
                                              use_proportion_study_AIMG == 4 ~6)) %>% 
  mutate(total_mods = use_proportion_formal_AIMG + use_proportion_class_AIMG + use_proportion_study_AIMG) %>% 
  summarise(mean = mean(total_mods), 
            sd = sd(total_mods),
            median = median(total_mods),
            median_class = median(use_proportion_class_AIMG))
```
...
use_frequency_figure <- raw_data %>% dplyr::select(study_read_frequency, formal_read_frequency, class_read_frequency,
  ...
  theme(axis.line = element_line(colour = "black"),
        ...
        legend.position = "bottom") + guides(fill=guide_legend(reverse = TRUE)) +
...
use_purposes_fig <- raw_data_purposes %>% filter(!is.na(communicate_administrative))  %>% 
  mutate(`Communicate administrative information` = factor(communicate_administrative, levels, ordered=TRUE),
         `Discuss course content` = factor(discuss_content, levels, ordered=TRUE),
         `Share notes & resources` = factor(share_notes, levels, ordered=TRUE),
         `Share answers or solutions` = factor(share_answers, levels, ordered=TRUE),
         `Coordinate group work` = factor(coordinate_groupwork, levels, ordered=TRUE),
         `Encourage and support each other` = factor(encourage, levels, ordered=TRUE),
         `Share non-academic content` = factor(share_non_academic, levels, ordered=TRUE),
         group_type = case_when(group_type == "formal"~"Formal AIMGs",
                                group_type =="class"~"Class AIMGs",
                                group_type == "group" ~ "Study AIMGs")) %>% 
  pivot_longer(cols = c(`Communicate administrative information`, `Discuss course content`,
                                            `Share notes & resources`, `Share answers or solutions`, `Coordinate group work` , `Encourage and support each other`, `Share non-academic content`), names_to = "Use_purpose", values_to = "response") %>% 
 group_by(group_type, Use_purpose, response)  %>% 
  ...
  mutate(group_type = factor(group_type, levels = c("Formal AIMGs", "Class AIMGs", "Study AIMGs"))) %>% 
...
formal_outcomes_data <- formal_outcomes_data %>% 
  mutate(accurate_administrative = `Please indicate your level of agreement with the following statements
 _formal_outcome_access_accurate_administrative_info_Column2`,
         use_academic_material = `Please indicate your level of agreement with the following statements
 _formal_outcome_access_useful_material_Column2`,
         understanding_of_work = `Please indicate your level of agreement with the following statements
 _formal_outcome_improves_understanding_Column2`,
         improves_AP = `Please indicate your level of agreement with the following statements
 _formal_outcome_improves_AP_Column2`,
         reduces_AS = `Please indicate your level of agreement with the following statements
 _formal_outcome_reduces_academic_stress_Column2`,
         cope_with_pressure = `Please indicate your level of agreement with the following statements
 _formal_outcome_cope_pressure_Column2`,
         group_work = `Please indicate your level of agreement with the following statements
 _formal_outcome_perform_group_work_Column2`,
 makes_anxious = `Please indicate your level of agreement with the following statements
 _formal_outcome_anxious_work_Column2`) %>% 
  dplyr::select(-c(`Please indicate your level of agreement with the following statements
 _formal_outcome_access_accurate_administrative_info_Column2`, `Please indicate your level of agreement with the following statements
 _formal_outcome_access_useful_material_Column2`, `Please indicate your level of agreement with the following statements
 _formal_outcome_improves_understanding_Column2`,`Please indicate your level of agreement with the following statements
 _formal_outcome_improves_AP_Column2`, `Please indicate your level of agreement with the following statements
 _formal_outcome_reduces_academic_stress_Column2`, `Please indicate your level of agreement with the following statements
 _formal_outcome_cope_pressure_Column2`, `Please indicate your level of agreement with the following statements
 _formal_outcome_perform_group_work_Column2`, `Please indicate your level of agreement with the following statements
 _formal_outcome_anxious_work_Column2`))

class_outcomes_data <- class_outcomes_data %>% 
  mutate(accurate_administrative = `Please indicate your level of agreement with the following statements_class_outcome_access_adminstrative_info_Column2`,
         use_academic_material = `Please indicate your level of agreement with the following statements_class_outcome_access_material_Column2`,
         understanding_of_work = `Please indicate your level of agreement with the following statements_class_outcome_improves_understanding_Column2`,
         improves_AP = `Please indicate your level of agreement with the following statements_class_outcome_improves_AP_Column2`,
         reduces_AS = `Please indicate your level of agreement with the following statements_class_outcome_reduces_stress_Column2`,
         cope_with_pressure = `Please indicate your level of agreement with the following statements_class_outcome_cope_pressure_Column2`,
         group_work = `Please indicate your level of agreement with the following statements_class_outcome_perform_group_Column2`,
 makes_anxious = `Please indicate your level of agreement with the following statements_class_outcome_anxious_work_Column2`) %>% 
  dplyr::select(-c(`Please indicate your level of agreement with the following statements_class_outcome_access_adminstrative_info_Column2`,
                   `Please indicate your level of agreement with the following statements_class_outcome_access_material_Column2`,
                   `Please indicate your level of agreement with the following statements_class_outcome_improves_understanding_Column2`,
                   `Please indicate your level of agreement with the following statements_class_outcome_improves_AP_Column2`,
                   `Please indicate your level of agreement with the following statements_class_outcome_reduces_stress_Column2`,
                   `Please indicate your level of agreement with the following statements_class_outcome_cope_pressure_Column2`,
                   `Please indicate your level of agreement with the following statements_class_outcome_perform_group_Column2`,
                   `Please indicate your level of agreement with the following statements_class_outcome_anxious_work_Column2`))

group_outcomes_data <- group_outcomes_data %>% 
  mutate(accurate_administrative = `Please indicate your level of agreement with the following statements_group_outcome_access_administrative_info_Column2`,
         use_academic_material = `Please indicate your level of agreement with the following statements_group_outcome_access_material_Column2`,
         understanding_of_work = `Please indicate your level of agreement with the following statements_group_outcome_improves_understanding_Column2`,
         improves_AP = `Please indicate your level of agreement with the following statements_group_outcome_improves_AP_Column2`,
         reduces_AS = `Please indicate your level of agreement with the following statements_group_outcome_reduces_stress_Column2`,
         cope_with_pressure = `Please indicate your level of agreement with the following statements_group_outcome_cope_pressure_Column2`,
         group_work = `Please indicate your level of agreement with the following statements_group_outcome_perform_group_Column2`,
 makes_anxious = `Please indicate your level of agreement with the following statements_group_outcome_anxious_work_Column2`) %>% 
  dplyr::select(-c(`Please indicate your level of agreement with the following statements_group_outcome_access_administrative_info_Column2`, 
                   `Please indicate your level of agreement with the following statements_group_outcome_access_material_Column2`,
                   `Please indicate your level of agreement with the following statements_group_outcome_improves_understanding_Column2`,
                   `Please indicate your level of agreement with the following statements_group_outcome_improves_AP_Column2`,
                   `Please indicate your level of agreement with the following statements_group_outcome_reduces_stress_Column2`,
                   `Please indicate your level of agreement with the following statements_group_outcome_cope_pressure_Column2`,
                   `Please indicate your level of agreement with the following statements_group_outcome_perform_group_Column2`,
                   `Please indicate your level of agreement with the following statements_group_outcome_anxious_work_Column2`))

raw_data_outcomes <- rbind(formal_outcomes_data, class_outcomes_data, group_outcomes_data) 
```

```{r}
levels = c("strongly agree", "agree", "neutral", "disagree", "strongly disagree")

use_outcomes_fig <- raw_data_outcomes %>% filter(!is.na(accurate_administrative))  %>% 
  mutate(`Access accurate administrative information` = factor(accurate_administrative, levels, ordered=TRUE),
          `Access useful academic material` = factor(use_academic_material, levels, ordered=TRUE),
         `Improves understanding of content` = factor(understanding_of_work, levels, ordered=TRUE),
         `Improves academic performance` = factor(improves_AP, levels, ordered=TRUE),
         `Reduces academic stress` = factor(reduces_AS, levels, ordered=TRUE),
         `Helps to cope with academic pressure` = factor(cope_with_pressure, levels, ordered=TRUE),
         `Perform effective group work`  = factor(group_work, levels, ordered=TRUE),
         `Increases anxiety about work`  = factor(makes_anxious, levels, ordered=TRUE),
         group_type = case_when(group_type == "formal"~"Formal AIMGs",
                                group_type =="class"~"Class AIMGs",
                                group_type == "group" ~ "Study AIMGs")) %>% 
           pivot_longer(cols = c(`Access accurate administrative information`,  `Access useful academic material`,
                                            `Improves understanding of content`, `Improves academic performance`, `Reduces academic stress`, `Helps to cope with academic pressure`, `Perform effective group work` , `Increases anxiety about work` ), names_to = "Use_outcome", values_to = "response") %>% 
 group_by(group_type, Use_outcome, response)  %>% 
  summarise(n = n()) %>% 
  ungroup() %>% 
  group_by(group_type, Use_outcome) %>% 
  mutate(count_resp = sum(n)) %>% 
  group_by(Use_outcome, add = TRUE) %>% 
  mutate(per = round(100*n/count_resp,2)) %>% 
  mutate(group_type = factor(group_type, levels = c("Formal AIMGs", "Class AIMGs", "Study AIMGs"))) %>% 
  ggplot(aes(x = Use_outcome, y = per, fill = response)) +
  geom_bar(stat = "identity", width = 0.8) + coord_flip() + facet_wrap(~group_type, ncol=1) + 
  scale_fill_brewer(palette = "RdYlGn", direction = -1)+
  scale_y_continuous(breaks = seq(0, 100, by=10))+
  labs(x = "Use Outcome", y = "Response proportion")+
  theme_minimal() + 
  coord_flip()+
  theme(axis.line = element_line(colour = "black"),
        axis.text.y = element_text(size = 10),
...
use_outcomes_fig
ggsave((filename="Figures/use_outcomes_figure.pdf"), scale = 1, width = 10, height=5, dpi = 600, limitsize = TRUE, use_outcomes_fig)
```
...
confint(AS_model_standardised_ceofs)
```
...
```{r}
raw_data_for_sem <- raw_data %>% dplyr::select(class_overall_participation, formal_overall_participation, study_overall_participation, GTS, LCS, academic_performance)
```

```{r}
raw_data_for_sem <- raw_data_for_sem
```
